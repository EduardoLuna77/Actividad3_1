...
var sValorCal="";
			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						...
						sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #EE2121; background-color: #EE2121";
	...
	if (sErr == "")
		document.getElementById("textoCal").innerHTML="Calif = "+nCalif;
	else
		alert(sErr);
}
